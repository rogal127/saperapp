            ...
            >
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-2" id="findingTypeGroup">
                        ...
                        <label class="finding-type-btn flex items-center gap-3 card cursor-pointer border-2 transition-all {{ old('type') === 'awaiting_wkz_classification' ? 'border-blue-500 bg-blue-500/10' : 'border-transparent' }}"
                            data-active-border="border-blue-500" data-active-bg="bg-blue-500/10">
                            <input type="radio" name="type" value="awaiting_wkz_classification" class="hidden" {{ old('type') === 'awaiting_wkz_classification' ? 'checked' : '' }}>
